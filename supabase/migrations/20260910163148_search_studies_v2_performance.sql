...
as $$
  ...
  scored as (
    ...
    left join lateral (
      select
        q.text_query is not null
          and ts_rank(array[0::real,0::real,0::real,1::real], b.busca_texto, q.text_query) > 0
          as title_match,
        q.text_query is not null
          and ts_rank(array[0::real,0::real,1::real,0::real], b.busca_texto, q.text_query) > 0
          as keyword_match,
        q.text_query is not null
          and ts_rank(array[0::real,1::real,0::real,0::real], b.busca_texto, q.text_query) > 0
          as summary_match,
        q.text_query is not null
          and ts_rank(array[1::real,0::real,0::real,0::real], b.busca_texto, q.text_query) > 0
          as content_match,
...
revoke all on function public.search_studies_v2(
  text,text,integer,integer,integer,text,text,text,text,text,boolean,integer,integer
) from public;

grant execute on function public.search_studies_v2(
  text,text,integer,integer,integer,text,text,text,text,text,boolean,integer,integer
